<template>
  <div>
    ...
    <validation-errors
      :xmlLink="formData.xmlLink"
      :xml="formData.xml"
      :errors="formData.validationErrors"
      :visible.sync="showValidation"
    />
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <span class="m--margin-right-10" v-if="hasErrors">
          <el-badge :value="formData.validationErrors.length">
            <el-button
              class="btn btn-feature"
              type="danger"
              plain
        ...
        <span class="m--margin-right-10" v-else>
          <el-button
            class="btn btn-feature"
            type="text"
            plain
        ...
        <el-button
          ...
          v-if="formData.patient && !formSubmitting"
        >
          <span v-if="!formSubmitting">Save & Validate</span>
        </el-button>
