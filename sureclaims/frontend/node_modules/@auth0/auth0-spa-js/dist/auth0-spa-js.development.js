(function (global, factory) {
    ...
    */
    ...
    var verify = function (options) {
        ...
        if (now < iatDate) {
            throw new Error("Issued At (iat) claim error in the ID token; current time (" + now + ") is before issued at time (" + iatDate + ")");
        }
        ...
        Auth0Client.prototype.handleRedirectCallback = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            queryStringFragments = window.location.href.split('?').slice(1);
